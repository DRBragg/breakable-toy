...
Card.create(catagory: "Question", body: "If you had a choice betweentwo superpowers - being invisible or flying  which would you choose?")
Card.create(catagory: "Question", body: "Why do you want to work for this company?")
Card.create(catagory: "Question", body: "Discribe the color yellow to someone who'e blind.")
Card.create(catagory: "Personal", body: "Talk about something you need to improve upon.")
Card.create(catagory: "Personal", body: "Talk about something your best trait.")
